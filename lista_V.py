...
for x in range(1067,3628):
    if x % 2 == 0 and x % 7 == 0: pares_div_sete += 1
print(f"pares e divisíveis por 7: {pares_div_sete}")
#-------------------------------------------------------
#-------------------------------------------------------
# Exercício D
print("============= Exercício D ==============")
...
for x in range(18644,33087):
    digitos = str(x)
    if '2' in digitos and '7' not in digitos: sortudos += 1
print(f"sortudos: {sortudos}")
#-------------------------------------------------------
#-------------------------------------------------------
# Exercício E
print("============= Exercício E ==============")
